...
values."
  (setq-default
   ...
   '(
     ...
     common-lisp
     (shell :variables
            shell-default-term-shell "/opt/bb/bin/zsh")
     prodigy
     ;; ----------------------------------------------------------------
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Sauce Code Powerline-14.5"
                               :size 19
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
...
you should place your code here."
  ...
  (load (concat dotspacemacs-directory "cygwin.el"))
  )
